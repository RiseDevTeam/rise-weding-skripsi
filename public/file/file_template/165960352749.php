         ...
         <div class="row mempelai">
           <div class="pria col-lg-6 col-md-6">
             <div class="card">
               ...
               <div class="card-body">
                 <h3>
                   <?php echo $data['nama_lengkap_pria'] ?>
                 </h3>
                 <p>
                   <?php echo $data['putra_dari'] . " Bpk. " . $data['nama_bapak_pria'] . " Ibu " . $data['nama_ibu_pria'] ?>
                 </p>
               </div>
             </div>
           </div>
           <div class="wanita col-lg-6 col-md-6">
             <div class="card">
               ...
               <div class="card-body">
                 ...
                 <p>
                   <?php echo $data['putri_dari'] . " Bpk. " . $data['nama_bapak_wanita'] . " Ibu " . $data['nama_ibu_wanita'] ?>
                 </p>
               </div>
             </div>
           </div>
