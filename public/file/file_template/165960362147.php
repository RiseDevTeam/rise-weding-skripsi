      ...
      <div class="container">
        ...
        <div class="resepsi1">
          ...
          <div class="jdt">
            ...
            <iframe width="1000" height="450" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.it/maps?q=<?php echo $data['lokasi_resepsi']; ?>&output=embed"></iframe>
          </div>
        </div>
      </div>
    </div>