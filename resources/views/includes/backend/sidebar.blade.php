<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html"
            ...
            <span class="ms-1 font-weight-bold">Haii {{ Auth::User()->name }} <br>
                <center> <b> sebagai {{ Auth::User()->status }}</b> </center>
            </span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item {{ set_active('kategori.index') }}">
                <a data-bs-toggle="collapse" href="#pagesExamples"
                    class="nav-link {{ set_active('kategori.index') }} {{ set_active('rincian_kategori.index') }} {{ set_active('sub_kategori.index') }} "
                ...
                <div class="collapse " id="pagesExamples">
                    <ul class="nav ms-4 ps-3">
                        @if (Auth::user()->status == 'admin')
                            ...
                            <li class="nav-item ">
                                <a class="nav-link {{ set_active('musik.index') }} "
                                    href="{{ route('musik.index') }}">
                                    <span class="sidenav-mini-icon"> R </span>
            ...
            @if (Auth::user()->status == 'admin')
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#menuVideo"
                        class="nav-link {{ set_active('petugas.index') }} {{ set_active('mitra.index') }} "
            ...
            @if (Auth::user()->status == 'mitra')
                <li class="nav-item">
                    <a class="nav-link {{ set_active('cashout-pembayaran') }} "
                        href="{{ route('cashout-pembayaran') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Cash Out</span>
                    </a>
                </li>
            @endif
            @if (Auth::user()->status == 'admin')
                ...
                <li class="nav-item">
                    <a class="nav-link {{ set_active('cashout_admin') }} " href="{{ route('cashout_admin') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Konfirmasi Cash Out</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#menuLaporan"
                        class="nav-link {{ set_active('laporan_cashout') }} {{ set_active('laporan_rekapitulasi') }}"
                        aria-controls="menu-video" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                    ...
                    <div class="collapse " id="menuLaporan">
                        <ul class="nav ms-4 ps-3">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link " href="{{ route('laporan_cashout') }}">
                                    <span class="sidenav-mini-icon"> P </span>
                                    <span class="sidenav-normal"> Laporan Cash Out </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link " href="{{ route('laporan_rekapitulasi') }}">
                                    <span class="sidenav-mini-icon"> M </span>
                                    <span class="sidenav-normal">Laporan Rekapitulasi </span>
                                </a>
                            </li>
            ...
            @if (Auth::user()->status == 'mitra')
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#menuLaporan"
                        class="nav-link {{ set_active('laporan_cashout_mitra') }} {{ set_active('laporan_penjualan') }} "
                        aria-controls="menu-video" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                    ...
                    <div class="collapse " id="menuLaporan">
                        <ul class="nav ms-4 ps-3">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link " href="{{ route('laporan_penjualan') }}">
                                    <span class="sidenav-mini-icon"> M </span>
